<nav x-data="{ open: false }" class="bg-cofima text-white">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @hasanyrole('directeur-general|admin')
                        <x-nav-link :href="route('validation.index')" :active="request()->routeIs('validation.*')">
                            Validation
                        </x-nav-link>
                    @endhasanyrole
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white/80 hover:text-white focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-cofima-dark">
